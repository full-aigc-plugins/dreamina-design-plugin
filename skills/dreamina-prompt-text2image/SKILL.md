...
description: Stub for the upstream Dreamina Skill 'dreamina-prompt-text2image'. The body is not copied into this plugin; it is tracked at full-aigc-skills/dreamina-skills under upstream_commit_sha.
...
This Skill is a thin metadata stub for `dreamina-prompt-text2image`. Its body is **not**
